"""
Authentication Service (feature-based)
Moved from app/features/auth/service.py with adjusted imports.
"""
...
class AuthService:
    ...
    async def register_user(self, db: AsyncSession, user_data: UserRegisterSchema) -> dict:
        ...
        return {
            ...
            "token": TokenSchema(access_token=access_token, expires_in=30 * 60),
        }
    ...
    async def login_user(self, db: AsyncSession, credentials: UserLoginSchema) -> dict:
        ...
        try:
            ...
            return {
                ...
                "token": TokenSchema(access_token=access_token, expires_in=expires_in_seconds),
